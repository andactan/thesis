...
if __name__ == '__main__':
    ...
    model = CompressiveTransformer(
        num_tokens = 20000,
        embedding_dim = 128,                 # embedding dimensions, embedding factorization from Albert paper
        dim = 512,
        depth = 12,
        sequence_len = 1024,
        memory_len = 1024,                # memory length
        ...
        attention_dropout = 0.1,            # dropout post-attention
